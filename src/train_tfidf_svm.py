...
def main() -> None:
    ...
    model_path = paths.models_dir / "tfidf_svm.joblib"
    ...
    save_json(
        ...
        paths.results_dir / "tfidf_svm_metrics.json",
    )

    (paths.results_dir / "tfidf_svm_report.txt").write_text(report, encoding="utf-8")
